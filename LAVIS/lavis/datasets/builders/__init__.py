...
from lavis.datasets.builders.retrieval_builder import (
    ...
    Flickr30kBuilder,
    ArtpediaVslCtxBuilder,
    ArtpediaVslOnlyBuilder,
    ArtpediaCtxOnlyBuilder,
)

from lavis.datasets.builders.classRet_builder import(
    ArtpediaClassRetBuilder,
)
from lavis.datasets.builders.classif_builder import(
    ArtpediaClassifBuilder,
    ArtpediaLongClassifBuilder,
)
