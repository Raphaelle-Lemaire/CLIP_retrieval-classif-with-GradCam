...
from lavis.datasets.datasets.artpedia_visual_context import Visuel_contextDataset, Visuel_contextEvalDataset
...
@registry.register_builder("artpedia_visual_context")
class ArtpediaVisualContextBuilder(BaseDatasetBuilder):
    train_dataset_cls = Visuel_contextDataset
    eval_dataset_cls = Visuel_contextEvalDataset

    DATASET_CONFIG_DICT = {"default": "configs/datasets/artpedia/visuel_context.yaml"}
