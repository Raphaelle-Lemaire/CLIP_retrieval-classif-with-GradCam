...
class RunnerBase:
    ...
    def optimizer(self):
        ...
        #print("optim", self.model.parameters(),self.model.module.classifier.parameters())
        #print("Model Parameters: Runner_base")
        #for name, param in self.model.named_parameters():
        #    print(f"Parameter name: {name}, shape: {param.shape}, requires_grad: {param.requires_grad}")

        #for name, param in self.model.named_parameters():
        #    if "clip_classifier" in name:
    ...
    def gradCam(self):
        ...
        logging.info("Start GradCam")
        self.model.train()

        train_stats = self.task._train_inner_loop(
            epoch=1,
        ...
        #ajouter des if gradCam dans _train_inner_loop voir gradCamOld
        # En gros, .grad, cam
    ...
    def eval_epoch(self, split_name, cur_epoch, skip_reload=False):
        ...
        ##modification: results = self.task.evaluation(model, data_loader)
